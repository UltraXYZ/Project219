...
def generate_lidar_blueprint(blueprint_library):
    ...
    lidar_blueprint.set_attribute('points_per_second', str(56000))#write the code for set points_per_second
    lidar_blueprint.set_attribute('rotation_frequency', str(80))#write the code for set rotation frequency
    lidar_blueprint.set_attribute('range', str(100))#write the code for set range
...
def semantic_lidar_data(point_cloud_data):
    ...
    for detection in point_cloud_data:
        ...
        print("Name of all objects nearby car distance_name_data",distance_name_data['name'])#write code here to display only name of object
